...
export class DeliveryPlanComponent implements OnInit ,OnDestroy{
  ...
  deliveryBind:any=[];
  deliveryData(){
    this.deliveryService.getDeliveryData().subscribe((res:any)=>{
  ...
  deliveryPlanDetails(item:any){
    const modalRef = this.modalService.open(DeliveryModalComponent, { size: 'lg' });
